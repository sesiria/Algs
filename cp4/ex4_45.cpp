...
/**
 * comopare two binary tree.
 * time complexity O(N)
 */ 
template <typename Comparable>
bool CompareBinaryTree(BinaryNode<Comparable> *t1, BinaryNode<Comparable> *t2)
{
    ...
    return CompareBinaryTree(t1->left, t2->left) && CompareBinaryTree(t1->right, t2->right);
}
