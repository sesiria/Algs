...
/**
 * Author: sesiria  2018
 * A implementation linklist-hashtable and linklist-hashmap
 * support to add, delete object by linklist. complexity O(1)
 * support to query any object by hashtable, complexity O(1)
 */
#ifndef LINK_HASH_SET
#define LINK_HASH_SET
